...
class ProjectWizard(QWizard):
    ...
    def accept(self):
        ...
        publisher = self.field("publisher")
...
class ProjectInfoPage(QWizardPage):
    ...
    def __init__(self, install_directory):
        ...
        self.publisherNameLabel = QLabel("&Publisher:")
        self.publisherNameLineEdit = QLineEdit()
        self.publisherNameLabel.setBuddy(self.publisherNameLineEdit)
        self.publisherNameLineEdit.setPlaceholderText("Book publisher")
        ...
        self.registerField("publisher*", self.publisherNameLineEdit)
        ...
        layout.addWidget(self.publisherNameLabel, 1, 0)
        layout.addWidget(self.publisherNameLineEdit, 1, 1)
        layout.addWidget(self.creatorNameLabel, 2, 0)
        layout.addWidget(self.creatorNameLineEdit, 2, 1)
        layout.addWidget(self.languageLabel, 3, 0)
        layout.addWidget(self.language, 3, 1)
        layout.addWidget(self.themeLabel, 4, 0)
        layout.addWidget(self.theme, 4, 1)
