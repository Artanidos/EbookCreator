...
class Settings(QDialog):
    ...
    def __init__(self, book, parent = None):
        ...
        layout.addWidget(QLabel("Publisher"), 1, 0)
        layout.addWidget(self.publisher, 1, 1, 1, 3)
        layout.addWidget(QLabel("Creator"), 2, 0)
        layout.addWidget(self.creator, 2, 1, 1, 3)
        layout.addWidget(QLabel("Language"), 3, 0)
        layout.addWidget(self.language, 3, 1)
        layout.addWidget(QLabel("Theme"), 4, 0)
        ...
        self.publisher.textChanged.connect(self.textChanged)
    ...
    def okClicked(self):
        ...
        self.book.publisher = self.publisher.text()
